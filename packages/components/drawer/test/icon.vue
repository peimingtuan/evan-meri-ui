<template>
    ...
    <m-drawer v-model="drawerStatus" :shadowClick="true" :shadow="true" :footFixed="false">
        <template #title>
            自定义标题
        ...
        <template #icon>
            <IconMeriActionPublish></IconMeriActionPublish>
        </template>
    </m-drawer>
</template>
...
import { IconMeriActionPublish } from "meri-icon";
import Drawer from "../index";

export default defineComponent({
    components: { Drawer, IconMeriActionPublish },
    setup() {
