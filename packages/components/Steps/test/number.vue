<template>
	<div class='container'>
		<m-steps
			...
			:style='{marginTop:layoutValue=="horizontal"?"100px":"0px"}'
			:source='activities'
			:size='sizeValue'
			:layout='layoutValue'
...
export default defineComponent({
	setup() {
		...
		const categoryOptions = ref(categoryList)
		...
		let categoryValue = ref(categoryOptions.value[0].label)
		...
		const change2 = (data: string, obj: any) => {
			categoryValue.value = obj.label
		}
